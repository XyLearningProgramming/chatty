"""Distributed concurrency backend backed by Redis Lua scripts + Pub/Sub."""
...
class RedisConcurrencyBackend(ConcurrencyBackend):
    """Distributed concurrency backend backed by Redis Lua scripts + Pub/Sub.

    The semaphore acquire waits for a Pub/Sub notification from
